            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg space-y-6">
                  ...
                  <>
                    ...
                    <div className="text-3xl font-bold text-gray-600">
                      ...
                      <span className="ml-3 text-sm px-2 py-1 bg-red-100 text-red-600 rounded font-medium">
                        {Math.round(
                          (1 - product.price / product.labellePrice) * 100
                        )}
                        % OFF
                      </span>
                    </div>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-[#6d447d] hover:bg-[#5a3866] text-white font-semibold rounded-lg shadow transition"
                >
                  Add to Cart
                </button>
                <button
                        ...
                        cart: [
                          {
                            ...
                            price: product.price,
                            labelledPrice: product.labellePrice,
                            qty: 1,
                          },
                        ],
                      },
                  ...
                  className="flex-1 px-6 py-3 bg-green-500 hover:bg-green-700 text-white font-semibold rounded-lg shadow transition"
                >
                  Buy Now
                </button>
              </div>
